...
namespace Zork
{
    class Program
    {
        ...
        static void InitializeRoomDescriptions()
        {
            ...
            roomMap["Canyon View"].Description = "You are at the top of a Great Cnayon on its south wall";
            ...
            roomMap["North of House"].Description = "You are facing the north side of a white hosue. There is no door here, and all the windows are barred";
            roomMap["Clearing"].Description = "You are in a clearing, with a forest suurounding you on the west and south";
        }
